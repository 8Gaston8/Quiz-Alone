console.log('Loading quiz version I data...');
...
const quizDataI = [
    ...
    {
        question: "🎉 Congratulations! Your answers qualify you for a special discount! 🎉",
        options: [
            "Apply 30% off (limited time)"
        ],
        funFact: "For a limited time only, get full access to Atly's premium features at 30% off! Don't miss out on this exclusive offer to transform your gluten-free dining experience!"
    }
];

console.log('Quiz version I data loaded successfully'); 